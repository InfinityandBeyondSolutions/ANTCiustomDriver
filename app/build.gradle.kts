...
android {
    ...
    // Use NDK r27+ for 16 KB alignment capable native build/tooling
    ...
    packaging {
        jniLibs {
            // Ensure shared libraries are packaged uncompressed (required for modern alignment)
...
dependencies {
    ...
    // Firebase (keep one approach to avoid version skew): use BOM + no explicit Firebase versions below.
    ...
    // Glide (keep one version)
    implementation("com.github.bumptech.glide:glide:4.16.0")
    kapt("com.github.bumptech.glide:compiler:4.16.0")

    implementation("androidx.activity:activity-ktx:1.8.0")

    // Coroutines (keep one version)
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.8.1")
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.8.1")
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-play-services:1.8.1")

    // Mapbox Maps SDK (NDK27 variants support 16 KB alignment)
    // Keep Mapbox module versions aligned.
    implementation("com.mapbox.maps:android-ndk27:11.8.0")
    implementation("com.mapbox.plugin:maps-locationcomponent-ndk27:11.8.0")
